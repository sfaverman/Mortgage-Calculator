...
<head>
    ...
    <title> My Simple Mortgage Calculator </title>
        <!--[if lt IE9]>
    ...
    <section class="container">
     ...
     <div id="navigation">
         ...
         <nav class="mainNav">
            <ul>
                ...
                <li><a href="PAGES/amortizationTable.html">Schedule</a></li>
     ...
     <article class="formMortCalc">
         <h3>Select Loan Terms:</h3>
               <p>Fixed
                  <input type="radio" name="term" value="30" checked="checked">30 Year
       ...
       <form action="#" method="get" id="formC" class="inGrp">
        	...
        	<input type="text" id="inCost" name="inCost" placeholder="500000" pattern="[0-9]*" title="Example: 800000" required>

        	<label for="inDown">Down Payment:</label>
        	<input type="text" id="inDown" name="inDown" placeholder="25000" pattern="[0-9]*" title="Example: 50000" required>

        	<label for="inInterest">Interest (APR %):</label>
        	<input type="text" id="inInterest" name="inInterest" size="5" placeholder="4.5" pattern="[0-9]*[.][0-9]*" title="Valid examples: 4.5, 5.25" required>
